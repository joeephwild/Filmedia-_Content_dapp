...
import {
  PROVIDER,
  CreatifyMarketplaceAddress,
  dynamicNftAddress,
  artistNFTAddress,
} from "./addresses";
import CreatifyMarketplaceAbi from "./abis/CreatifyMarketplace.json";
import dynamicNftAbi from "./abis/CreatifyDynamicNFTAbi.json";
import artistNFTAbi from "./abis/CreatifyArtistNFTAbi.json";
import AsyncStorage from "@react-native-async-storage/async-storage";
import { Alert } from "react-native";
import { getAccountPhrase } from "@rly-network/mobile-sdk";

let CreatifyMarketplaceContract: any,
...
const connect = async () => {
  try {
    ...
    CreatifyMarketplaceContract = new ethers.Contract(
      CreatifyMarketplaceAddress,
      CreatifyMarketplaceAbi,
      signer
    );
...
export const _listNFT = async ({
  ...
  try {
    const tx = await CreatifyMarketplaceContract.listNFT(
      _nft,
      tokenId,
      _artistAddr
    );
...
export const _addNFTForArtist = async ({
  ...
  try {
    const tx = await CreatifyMarketplaceContract.addNFTForArtist(
      _artistAddr,
      nfts
    );
    await tx.wait();
...
export const _deposit = async ({
  ...
  try {
    ...
    const tx = await CreatifyMarketplaceContract.deposit({
      value: valueToSend,
    });
...
export const _subcribeToArtist = async ({
  ...
  try {
    const tx = await CreatifyMarketplaceContract.subcribeToArtist(
      _artistAddr,
      1
    );
    await tx.wait();
...
export const _cancelSubcribtion = async ({
  ...
  try {
    const tx = await CreatifyMarketplaceContract(_artistAddr);
    await tx.wait();
    console.log("Transaction successful:", tx.hash);
  } catch (error) {
...
export const _setTokenId = async ({
  ...
  try {
    const tx = await CreatifyMarketplaceContract.setTokenId(
      subcriberAddress,
      artistAddress,
      tokenId,
      nftAddress
...
export const _checkIfUserIsSubcribed = async ({
  ...
  try {
    const isSubscribed = await CreatifyMarketplaceContract(
      subcriberAddress,
      artistAddress
    );
...
export const getSubcribers = async (): Promise<any> => {
  try {
    const subcribers = await CreatifyMarketplaceContract.getSubcribers();
    return subcribers;
  } catch (error) {
...
export const _getAnalytics = async ({
  ...
  try {
    const analytics = await CreatifyMarketplaceContract.getAnalytics(
      subcriberAddress,
      artistAddress
    );
    return analytics;
...
export const _getTokenId = async ({
  ...
  try {
    const tokenId = await CreatifyMarketplaceContract.getTokenId(
      subcriberAddress,
      artistAddress
    );
    return tokenId;
...
export const _getMusicNFT = async ({
  ...
  try {
    const musicNFT = await CreatifyMarketplaceContract.getMusicNFT(
      tokenId,
      artistAddress
    );
    return musicNFT;
...
export const _getMusic = async ({
  ...
  try {
    const musicInfo = await CreatifyMarketplaceContract.getMusic(tokenId);
    return musicInfo;
  } catch (error) {
...
export const _getArtist = async ({
  ...
  try {
    const artistInfo = await CreatifyMarketplaceContract.getArtist(
      artistAddress
    );
    return artistInfo;
  } catch (error) {
...
export const _isWalletAnArtist = async ({
  ...
  try {
    const isAnArtist = await CreatifyMarketplaceContract.isWalletAnArtist(
      artistAddress
    );
    return isAnArtist;
  } catch (error) {
...
export const _getAllArtist = async (): Promise<any> => {
  try {
    const artists = await CreatifyMarketplaceContract.getAllArtists();
    return artists;
  } catch (error) {
    console.error("Error calling getArtist:", error);
...
export const _getUser = async ({
  ...
  try {
    const userInfo = await CreatifyMarketplaceContract.getUser(userAddress);
    return userInfo;
  } catch (error) {
...
export const _getUserBalance = async ({
  ...
  try {
    const balance = await CreatifyMarketplaceContract.getUserBalance(
      userAddress
    );
