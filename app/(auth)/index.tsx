...
const SignUp = () => {
  ...
  const RenderItem = ({ item }: { item: any }) => (
    <View
      className="flex justify-center items-center m-1.5"
      style={{ width: 100 }}
    >
      <Image
  ...
  return (
    <SafeAreaView className="flex-1 min-h-screen items-center justify-center w-full">
      ...
      <View className="">
        {page === 0 && (
          <View className="px-[20px] py-4 h-full space-y-[16px] flex">
            ...
            <View className="space-y-2">
              <Text className="font-opensans-bold text-[#fff] font-bold text-[10px]">
                What’s your email?
              </Text>
              <TextInput
              ...
              />
              <Text className="font-opensans-regular font-bold text-[10px] text-[#FBF4FB]">
            ...
            <View className="w-full items-center justify-center flex-col flex-1">
              <TouchableOpacity
                ...
                className="bg-[#fc3c44] rounded-full py-[16px] mt-[10px] items-center justify-center px-10"
              >
              ...
              <View className="flex flex-row my-6">
                <Text className="font-opensans-regular font-bold text-[14px] text-white">
                  Already signed up?
                </Text>
                <Link
                  className="font-opensans-bold text-[#fc3c44] font-bold text-[14px] mx-2"
                  href={"/login"}
                >
                  Log In
                </Link>
        ...
        {page === 1 && (
          <View className="px-[20px] py-4 h-full space-y-[16px] flex">
            ...
            <View className="space-y-2">
              <Text className="font-opensans-bold text-[#fff] font-bold text-[10px] mb-2">
              ...
              <View className="flex flex-row">
                <Text className="font-opensans-regular text-[10px] text-[#FBF4FB] mr-1">
                  This is required so we can tailor the contents with PG.
                </Text>
                <Link
                  className="font-opensans-bold text-[10px] text-[#FBF4FB]"
                  href={"/"}
                >
                  Read more
                </Link>
            ...
            <View className="space-y-2 z-10">
              ...
              <Text className="font-opensans-regular text-[10px] text-[#FBF4FB]">
                We have representation for every Identity
              </Text>
            </View>
            <View className="space-y-2">
              <Text className="font-opensans-bold text-[#fff] font-bold text-[10px]">
              ...
              />
              <Text className="font-opensans-regular text-[10px] text-[#FBF4FB]">
                This will be visible to everyone as a name to your Profile
              </Text>
            </View>
            <View className="w-full items-center justify-center flex-col flex-1">
              <TouchableOpacity
        ...
        {page === 2 && (
          <ScrollView className="px-[20px] py-4 h-full space-y-[16px] flex">
            <View className="flex items-center mt-20 mb-4">
              <Text className="text-[24px] font-opensans-bold text-[#fff] mb-14 text-center">
                Creatify
              </Text>
            ...
            <View className="w-full items-center justify-center flex-col flex-1 pt-5">
              <TouchableOpacity
                ...
                className="bg-[#fc3c44] rounded-full py-[16px] mt-[10px] items-center justify-center px-[30px]"
              >
                <Text className="text-[16px]  font-opensans-bold text-[#fff]">
                  {action ? action : "Next"}
                </Text>
              ...
              <View className="flex flex-row my-6">
                <Text className="font-opensans-regular font-bold text-[14px] text-white mb-6">
                  Already signed up?
                </Text>
                <Link href={"/login"}>
                  <Text className="font-opensans-bold text-[#fc3c44] font-bold text-[14px] mx-2">
                    login
                  </Text>
                </Link>
              </View>
