  ...
  return (
    <View>
      <View className="flex-row items-center justify-center">
        <Text className="w-[200px] text-[12px] text-[#fc3c44] text-center font-bold">
            ...
            {active === item.title && item.title === "Wallet" && (
              <View className="space-y-9">
                <View className="">
                  ...
                  <TouchableOpacity
                    onPress={handleNext}
                    className="bg-[#fc3c44] flex-row itms-center justify-center py-[8px] px-[24px] mt-9 rounded-[40px]"
                  >
