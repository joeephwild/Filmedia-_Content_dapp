...
const PaymentProcessing = ({
  ...
  return (
    <View className="relative">
      <View className="bg-[#fc3c44] w-[40px] mb-96 h-[40px] rounded-full absolute -top-9  right-[130px] p-[10px] items-center justify-center">
        <ActivityIndicator size="large" />
      </View>

      <View className="mt-[16px] items-center ">
        <Text className="text-[14px] font-bod text-[#fc3c44]">
          Payment Processing
        </Text>
        ...
        <View className="mt-[16px] space-y-[16px]">
          <View className="bg-[#fc3c44] px-[24px] py-[8px]  rounded-[40px]">
