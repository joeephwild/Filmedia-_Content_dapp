    ...
    <View className="min-h-screen w-[391px] items-center">
      ...
      <View className="px-[16px] space-y-[16px] mt-[43px]">
        <Text className="text-[24px] font-bold text-[#fff] text-center">
          Welcome to Creatify, where Social Content and blockchain unite!
        </Text>
      ...
      <TouchableOpacity
        ...
        className="bg-[#fc3c44] w-[80%] mt-[160px] mx-4 items-center justify-center px-[40px] py-[16px] rounded-lg"
      >
